...
class CreateTableMacroClassificationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('table_macro_classifications', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('table_macro_classifications');
    }
}
