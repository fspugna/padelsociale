                ...
                <form action="{{ route('admin.rankings.store') }}" method="POST">
                    ...
                    @foreach ($data as $row)  
                        ...
                        <tr style="background-color: {{ $bgcolors[$sel_color] }}">                            
                            ...
                            <td>
                                @php
                                $punti_name = $row['id_zone'].'_'.$row['id_category'].'_'.$row['id_category_type'].'_'.$row['id_player'].'_G'.$row['Girone_won'].$row['Girone_lost'].'_'.$incontri_brackets[$row['id_zone']][$row['id_category']][$row['id_category_type']].'T'.$row['Tabellone_won'].$row['Tabellone_lost'];
                                @endphp
                                {!! Form::text($punti_name, isset($rankings[$row['id_player']]) ? $rankings[$row['id_player']] : null, ['id' => $punti_name, 'class' => 'form-control points']) !!}
                            </td>
                        </tr>    
