<div id="modal-schedule-macro" class="modal fade" tabindex="-1" role="dialog">
        ...
        <form id="match-schedule-form" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="id_macro_match" id="id_macro_match">
                    <button type="button" class="btn btn-danger" id="btn_del_schedule_macro" >Elimina Programma</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Annulla</button>
                    <button type="button" class="btn btn-primary" id="btn_schedule_macro" >Salva</button>                        
                </div>      
            </div><!-- /.modal-content -->
        </form>
    </div><!-- /.modal-dialog -->
