 ...
 */
class MacroScore extends Model
{
    //use SoftDeletes;

    public $table = 'macro_scores';
     ...
     **/
    public function macro_match()
    {
        return $this->belongsTo(\App\Models\MacroMatch::class, 'id_match');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function macro_team()
    {
